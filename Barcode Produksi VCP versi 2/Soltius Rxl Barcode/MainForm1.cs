    ...
    public partial class MainForm1 : Form
    {
        ...
        private void _PrintDocument_BeginPrint(object sender, PrintEventArgs e) {
            try {
                ...
                //        select t;
                var fullSPK1 = txtSPKYear.Text + txtSPKMid.Text + txtSPKNum.Text;
                int rePrint1 = 0;
                ...
                connection.command.CommandText = "call cetak_barcodeProd('" + fullSPK1 + "','" + rePrint1 + "','" +
                                      cmbMerk.Text + "','" + cmbStyle.Text + "','" + cmbWarna.Text + "','" +
                                      cmbSize.Text + "','" + txtQty.Text + "')";
                connection.command.CommandTimeout = 10000;
                DataSet ds = new DataSet();
                connection.adapter.SelectCommand = connection.command;
                connection.adapter.Fill(DsShoesBarcode, "STYLE_DESC");
        ...
        private void _PrintDocument_PrintPage(object sender, PrintPageEventArgs e)
        {
            try
            {
                ...
                if (!_FirstPagePrinted && _PrintHelper.LabelStartRow > 1)
                {
                    ...
                    //currentRowIndex = dgResult.CurrentRow.Index;
                ...
                int quantityPrinted = dgResult.Rows.Count-1;
                ...
                for (a = 0; a <= dgResult.Rows.Count - 1; a++)
                {
                    ...
                    if (!_FirstPagePrinted && _PrintHelper.LabelStartColumn > 1)
                    {
                        ...
                        string yearText = Convert.ToString(dgResult[3,a].Value + "!");
                        ...
                        string dateText = Convert.ToString(dgResult[0,a].Value);
                        string asText;
                        ...
                        float minusWidth = barcodeRectangle.Width - (barcodeRectangle.Width * (barcodeWidthScale / 65F));
                        ...
                        barcodeRectangle.Location = new PointF(barcodeRectangle.Left + (minusWidth/5F), barcodeRectangle.Y);
                        ...
                        BarCodePreview.Text = Convert.ToString(dgResult[4, a].Value);
