...
//=====================================================================================================================//
        ...
        private void _PrintDocument_PrintPage(object sender, PrintPageEventArgs e)
        {
            try
            {
                ...
                float pageTopMargin = (float)(e.MarginBounds.Top);
                ...
                if (TopTextFontStyleLabel.Text == "Arial, 8.25pt, Regular")
                {
                    ...
                    colourTextFont = new System.Drawing.Font("Arial", 15.5F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                ...
                while (currentRowIndex <= rowCount)
                {
                    ...
                    while (_PrintHelper.HasMoreItems() && currentColumnIndex <= columnCount)
                    {
                        ...
                        RectangleF styleTextRectangle = new RectangleF(new PointF(currentX + labelLeftMargin, currentY + labelTopMargin), new SizeF(label_left_size + 1, styleTextSize.Height));
                        RectangleF colourTextRectangle = new RectangleF(new PointF(currentX + labelLeftMargin, (styleTextRectangle.Height + labelRectangle.Top)), new SizeF(label_left_size + 1, colourTextSize.Height));
                        RectangleF sizeTextRectangle = new RectangleF(new PointF(currentX + labelLeftMargin, (styleTextRectangle.Height + colourTextRectangle.Height + labelRectangle.Top)), new SizeF(label_left_size + 1, sizeTextSize.Height));
                        ...
                        RectangleF colourTextRectangle_dot = new RectangleF(new PointF(currentX + labelLeftMargin + colourTextRectangle.Width, (styleTextRectangle.Height + labelRectangle.Top)), new SizeF((labelWidth - labelRightMargin) - label_left_size, colourTextSize.Height));
                        RectangleF sizeTextRectangle_dot = new RectangleF(new PointF(currentX + labelLeftMargin + sizeTextRectangle.Width, (styleTextRectangle.Height + colourTextRectangle.Height + labelRectangle.Top)), new SizeF((labelWidth - labelRightMargin) - label_left_size, sizeTextSize.Height));
                        ...
                        RectangleF brandTextRectangle = new RectangleF(new PointF(currentX + labelLeftMargin, (styleTextRectangle.Height + colourTextRectangle.Height + sizeTextRectangle.Height + labelRectangle.Top)), new SizeF(labelWidth - labelRightMargin, brandTextSize.Height));
                        
                        
                       
                        SizeF asTextSize = g.MeasureString(asText, asTextFont, (int)(labelWidth * 100F), textFormatLeft).ToSize();
                        RectangleF asTextRectangle = new RectangleF(new PointF(currentX + labelLeftMargin, (styleTextRectangle.Height + colourTextRectangle.Height + sizeTextRectangle.Height + brandTextRectangle.Height + labelRectangle.Top)), new SizeF(labelWidth - labelRightMargin, asTextSize.Height));

                        
                        SizeF dateTextSize = g.MeasureString(dateText, dateTextFont, (int)(labelWidth * 100F), textFormatRight).ToSize();
                        RectangleF dateTextRectangle = new RectangleF(new PointF(currentX + labelLeftMargin + 7, asTextRectangle.Y), new SizeF(((labelWidth - labelRightMargin) / 2), dateTextSize.Height));
                        ...
                        RectangleF barcodeRectangle = new RectangleF(new PointF(((currentX - 10 + dateTextRectangle.Width) + (dateTextSize.Width / 2)), styleTextRectangle.Bottom + colourTextRectangle.Height - 3), new SizeF(((labelWidth / 2) - labelRightMargin - (brandTextSize.Width / 2)), (sizeTextSize.Height + brandTextSize.Height)));
                        ...
                        g.FillRectangles(Brushes.Transparent, new RectangleF[] { labelRectangle, styleTextRectangle, barcodeRectangle, sizeTextRectangle, colourTextRectangle, asTextRectangle, madeTextRectangle });
